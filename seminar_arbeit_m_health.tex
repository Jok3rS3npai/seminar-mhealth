...
\begin{document}
	...
	\section{Informationen zu den Nutzern und Verordneten}
		...
		\subsection{Nutzer}
			...
			\end{figure}
			In der Tabelle sieht man die Verteilung der Nutzer und aus welchen Bereichen die Verordneten kommen. Deutlich aus der Tabelle zu erkennen ist, dass $\frac{2}{3}$ der Nutzer von DiGA Frauen sind. Zusätzlich kann man noch aus der Tabelle lesen das mit fast 40 prozent der größte Teil der Verordneten Hausärzte sind.
			
			Jedoch stellt man fest das dies nur 12 Prozent der 185.000 ertragsärztlichen Versorgung teilnehmenden Leistungserbringer. Dennoch hat sich seit den Analysen des DiGA Reports der TK 2022 (Stichtag: 30. Sptember 2021) der Anteil an teilnehmenden Verordneten, sich um den Faktor 3 erhöht. %Weiter machen bei gelber Markierung Seite 28%
