...
\begin{document}
	...
	\section{Informationen zu den Nutzern und Verordneten}
		...
		\subsection{Vergleich von Nutzern und Nicht-Nutzern von DiGA}
			\begin{figure}[htbp]
				\includegraphics[width=\textwidth]{./grafiken/tabelle_vergleich_nutzer_nicht_nutzer_diga}
			...
			\end{figure}
			%Noch figures richtig formatieren width=0.5 textwidth und dann figure zentral machen%
